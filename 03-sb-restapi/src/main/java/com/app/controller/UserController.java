...
public class UserController {
	...
	public void createUser(@RequestBody User user) {
		log.info("UserController :: createUser {}", user.toString());
	...
	public void updateUser(@PathVariable Long userId, @RequestBody User user) {
		log.info("UserController :: updateUser {} {}", userId ,user.toString());
		userService.updateUser(userId, user);
	}

	@PatchMapping("{userId}")
	public void updateUserPassword(@PathVariable Long userId, @RequestBody User user) {
		log.info("UserController :: updateUserPassword {} {}", userId ,user.toString());
