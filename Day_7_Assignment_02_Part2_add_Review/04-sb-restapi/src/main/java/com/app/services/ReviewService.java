...
public class ReviewService implements IReviewService {
	...
	public void createReview(Review review) {
		...
		log.info("ReviewService :: createReview :: Review created successfully for given Product {}",review.getProduct().getId());
	}
	...
	public void updateReview(Long id, Review inputReview) {
		...
		if(review.getProduct().getId() == inputReview.getProduct().getId()) {
